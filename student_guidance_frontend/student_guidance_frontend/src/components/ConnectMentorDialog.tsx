...
// export const ConnectMentorDialog = ({ open, onOpenChange, groupId }: ConnectMentorDialogProps) => {
...
//   useEffect(() => {
//     if (open && groupId) {
//       fetch(`http://localhost:8080/api/group-chat/potential-mentors/${groupId}`)
//         .then((res) => res.json())
...
//                 <Card key={mentor.id} className="p-3 flex items-center justify-between">
...
//             <span className="text-xs text-muted-foreground">{selectedMentors.length} selected</span>
