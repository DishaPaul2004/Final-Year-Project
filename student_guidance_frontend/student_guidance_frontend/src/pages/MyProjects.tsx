...
//     abstract: "A full-stack e-commerce solution with payment integration",
...
//     ],
//     imageUrl: "https://images.unsplash.com/photo-1557821552-17105176677c?w=400&h=300&fit=crop",
//   },
// ];
...
//         </div>
  ...
  //         size="icon"
  //         className="fixed bottom-6 left-6 h-14 w-14 rounded-full shadow-elevated"
  //       >
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        {loading ? (
          ...
          <div className="text-center bg-card rounded-xl p-12 border shadow-sm">
            ...
            <Button onClick={() => navigate("/")}>Explore All Projects</Button>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
